...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.name(wd, "jdfdsfgs", "gdhf", "kldfgj")
        self.address(wd, "ertwerwte")
        self.telefon(wd, "34534534", "5687454653456")
        self.email(wd, "mous_dom@mail.ru")
        self.bd(wd, "1974", "January", "11")
        self.sabmit(wd)
        self.logout(wd)
    ...
    def bd(self, wd, byear, bmounth, bday):
        wd.find_element_by_name("bday").click()
        Select(wd.find_element_by_name("bday")).select_by_visible_text("%s" % bday)
        wd.find_element_by_name("bday").click()
        wd.find_element_by_name("bmonth").click()
        Select(wd.find_element_by_name("bmonth")).select_by_visible_text("%s" % bmounth)
        wd.find_element_by_name("bmonth").click()
    ...
    def telefon(self, wd, home_tel, mobile_tel):
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("%s" % home_tel)
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("%s" % mobile_tel)
    ...
    def name(self, wd, firstname, middlname, lastname):
